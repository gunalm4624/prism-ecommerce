...
export function SignInForm() {
  ...
  return (
    <div className="card mt-6 border max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <p className="text-sm text-center">
        New here? <a href="/auth/signup" className="text-blue-500">Create an account</a>
      </p>
    </div>
  );
}
